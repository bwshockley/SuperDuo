...
public class BookListAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        // Changed from the DownloadImage method to include Picasso instead.  Loads images faster
        // and maintains a local cache so that it displays book covers offline.
