...
public class MainActivity extends ActionBarActivity
{
    ...
    // For periodic updates using AlarmManager
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Moved score update into menu action item for now.
        // Also check if network is available first.
